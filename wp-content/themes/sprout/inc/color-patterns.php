...
.colors-custom.page:not(.sprout-front-page) .entry-title,
...
.colors-custom .sprout-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.sprout-front-page .panel-content .recent-posts article,
...
.colors-custom.sprout-front-page article:not(.has-post-thumbnail):not(:first-child),
